...
| Figure 6 | figure5_evo2_prioritization | Evo2 变异优先级 | a-b |
...
| --- | --- | --- |
| Supplementary Data 1 | 样本级评分、下载清单、基因覆盖 | `nampt_axis_sample_scores.csv`（346 行）、`geo_processed_download_manifest.csv`、`nampt_axis_gene_coverage.csv` |
...
*2026-09-20 生成。图注语言为投稿可直接用；面板内容来自 scripts/plot_*.py 实际渲染定义。*
