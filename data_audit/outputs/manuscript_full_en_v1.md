...
- Large cohorts support the two-program framework: in GSE272133<sup>[5]</sup> skeletal muscle (n = 51), nad_salvage_core α = 0.79, sirtuin_repair α = 0.82, ampk_mitochondria_repair α = 0.83, oxidative_stress_repair α = 0.91, dna_damage_repair α = 0.86; GSE305038<sup>[6]</sup> (n = 24) module-α mean 0.78; GSE32575<sup>[7]</sup> monocytes (n = 47) α mean 0.60.
...
**Approach.** Monocytes (GSE32575<sup>[7]</sup>), skeletal muscle (GSE272133<sup>[5]</sup>), visceral adipose (GSE294150) were integrated.
